...
import { Q3_5Answer } from '@/lib/types/process-orchestration';
import { PROCESS_ORCHESTRATION_QUESTIONS } from '@/lib/constants/process-orchestration';

interface Q3_5IntegrationStrategyFormProps {
  onNext: (answer: Q3_5Answer) => void;
  onPrevious?: () => void;
  currentAnswer?: Q3_5Answer;
}

export function Q3_5IntegrationStrategyForm({
  onNext,
  onPrevious,
  currentAnswer,
}: Q3_5IntegrationStrategyFormProps) {
  const [selected, setSelected] = React.useState<Q3_5Answer | undefined>(currentAnswer);
  const question = PROCESS_ORCHESTRATION_QUESTIONS.Q3_5;

  const handleSelect = (optionId: string) => {
    setSelected(optionId as Q3_5Answer);
  };
