...
import { CriteriaScore } from '@/lib/types/sourcing-model';
import { SCORE_LABELS } from '@/lib/constants/sourcing-model';

interface SourcingModelCriteriaRowProps {
  title: string;
  weight: number;
  description: string;
  data: CriteriaScore;
...
export default function SourcingModelCriteriaRow({
  title,
  weight,
  description,
  data,
  onChange,
}: SourcingModelCriteriaRowProps) {
